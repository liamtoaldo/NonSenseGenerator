...
When the user confirms it through generation<br>
Then the selected terms are saved in the public dictionary for future use<br>
### User story 4.2
Given a term from the input is already present in the dictionary<br>
When the system attempts to add it again<br>
...
### User story 6.1
Given a nonsense sentence has been generated<br>
When the system decides to save the generated sentence<br>
Then the sentence is stored with metadata (time, output)<br>
### User story 6.2
